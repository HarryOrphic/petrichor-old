...
$to = "harry@runic.services";														// To Address
$toAlt = "";												// Additional Recipients
$from = "harry@runic.services";													// From Address
$fromName = "Petrichor";											// From Name
